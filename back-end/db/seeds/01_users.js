  ...
  return knex('users').del()
    .then(function () {
      ...
      return knex('users').insert([
        ...
        {first_name: 'Beth', last_name: 'Betilda', email: 'bethy@gmail.com', avatar: 'ttps://pr.sssagent.com/img/a5.png'},
        ...
        {first_name: 'Marie', last_name: 'Barker', email: 'mariebarker22@gamil.com', avatar: 'https://pr.sssagent.com/img/a14.png'},
      ]);
    });
};
